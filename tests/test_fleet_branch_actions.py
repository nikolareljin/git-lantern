...
def test_fleet_plan_records_clones_missing_local_repo_into_repo_basename_when_available(monkeypatch, tmp_path):
...
def test_fleet_missing_local_destination_keeps_literal_non_namespaced_names():
